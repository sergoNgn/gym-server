...
const create_client_base =
  "CREATE TABLE IF NOT EXISTS clients_base (client_id int references clients(id), exercise_id int references exercises(id), data json, PRIMARY KEY(client_id, exercise_id))";
